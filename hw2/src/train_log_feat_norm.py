...
def train(X_train,Y_train):
    ...
    # No batch
    # Iteration  4900 :
    # Train:  0.856920629308821 0.30728860336365743
    # Valid:  0.8532358516111562 0.32454199764769615
    # 3454 0.8571681103058159 640 0.8583807202816138
    # batch
    # Iteration  1900 :
    # Train:  0.8555771610394202 0.3085326736765742
    # Valid:  0.8572975900352018 0.3245769665070593
    # 1034 0.85607212303341 1531 0.8581099377200109
    return w
...
def scaling(X):
    ...
    Maxs = np.ones(X.shape[1])
    Mins = np.zeros(X.shape[1])
    Maxs[index] = Max[index]
    Mins[index] = Min[index]
    X_data = (X - Mins)/(Maxs - Mins)
    # print(X_data)
    return X_data, Maxs, Mins
...
if __name__ == '__main__' :
    ...
    np.save("logistic_norn_batch_2.npy",model)
    # print(model.shape)